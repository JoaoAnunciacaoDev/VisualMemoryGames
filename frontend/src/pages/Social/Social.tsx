...
import { myActivitiesQuery, setFollowing, socialFeedQuery, socialKeys, userSearchQuery, weeklyReleasesQuery, type UserProfile } from '@/features/social/queries';
...
export default function Social() {
  ...
  const releasesQuery = useQuery({ ...weeklyReleasesQuery(), enabled: search.tab === 'feed' });
      ...
      <div className={styles.content}>
        {search.tab === 'feed' && (
          <SocialFeed
            ...
            releases={releasesQuery.data ?? []} emptyMessage="Nenhuma atividade recente. Siga mais pessoas!"
