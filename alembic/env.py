...
from app.models import user, game, user_game, tierlist, custom_lists, email_verification, password_reset, steam_account, itch_account, follow, activity, patch_note  # noqa
